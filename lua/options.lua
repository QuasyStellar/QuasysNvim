...
vim.wo.number = true -- Показывает абсолютные номера строк для более точного ориентира
vim.wo.relativenumber = true -- Включает относительные номера строк (удобно для навигации)
...
vim.opt.wrap = true -- Отключает перенос строк, чтобы каждая строка отображалась целиком
